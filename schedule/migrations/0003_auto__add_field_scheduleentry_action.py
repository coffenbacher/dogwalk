...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduleEntry.action'
        db.add_column(u'schedule_scheduleentry', 'action',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduleEntry.action'
        db.delete_column(u'schedule_scheduleentry', 'action')
