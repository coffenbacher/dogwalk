...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ScheduleEntry.day'
        db.add_column(u'schedule_scheduleentry', 'day',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'ScheduleEntry.start'
        db.add_column(u'schedule_scheduleentry', 'start',
                      self.gf('django.db.models.fields.TimeField')(default='00:00:00'),
                      keep_default=False)

        # Adding field 'ScheduleEntry.end'
        db.add_column(u'schedule_scheduleentry', 'end',
                      self.gf('django.db.models.fields.TimeField')(default='00:00:00'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScheduleEntry.day'
        db.delete_column(u'schedule_scheduleentry', 'day')

        # Deleting field 'ScheduleEntry.start'
        db.delete_column(u'schedule_scheduleentry', 'start')

        # Deleting field 'ScheduleEntry.end'
        db.delete_column(u'schedule_scheduleentry', 'end')
