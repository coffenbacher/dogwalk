...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PDog.walked'
        db.delete_column(u'schedule_pdog', 'walked')
        db.add_column(u'schedule_pdog', 'walked', self.gf('django.db.models.fields.PositiveIntegerField')(default=10))
        # Adding field 'Event.pwalker'
        db.add_column(u'schedule_event', 'pwalker',
                      self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, related_name='events', to=orm['schedule.PWalker']),
                      keep_default=False)

        # Removing index on 'Event', fields ['type']
        db.delete_index(u'schedule_event', ['type'])

        # Removing index on 'Event', fields ['time']
        db.delete_index(u'schedule_event', ['time'])


    def backwards(self, orm):
        # Adding index on 'Event', fields ['time']
        db.create_index(u'schedule_event', ['time'])

        # Adding index on 'Event', fields ['type']
        db.create_index(u'schedule_event', ['type'])


        # Changing field 'PDog.walked'
        db.alter_column(u'schedule_pdog', 'walked', self.gf('django.db.models.fields.BooleanField')())
        # Deleting field 'Event.pwalker'
        db.delete_column(u'schedule_event', 'pwalker_id')
    ...
    models = {
        ...
        u'schedule.event': {
            ...
            'pwalker': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'events'", 'to': u"orm['schedule.PWalker']"}),
        ...
        u'schedule.pdog': {
            ...
            'walked': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
        u'schedule.pwalker': {
