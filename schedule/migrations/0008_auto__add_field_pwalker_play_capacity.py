...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PWalker.play_capacity'
        db.add_column(u'schedule_pwalker', 'play_capacity',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PWalker.play_capacity'
        db.delete_column(u'schedule_pwalker', 'play_capacity')
    ...
    models = {
        ...
        u'schedule.pwalker': {
            ...
            'node': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['graph.Node']"}),
            'play_capacity': ('django.db.models.fields.PositiveIntegerField', [], {'default': '8'}),
